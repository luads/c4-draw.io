...
Draw.loadPlugin(function (ui) {
    ...
    C4Person.prototype.create = function () {
        var group = new mxCell('', new mxGeometry(0, 0, 170, 180), 'group;rounded=0;labelBackgroundColor=none;fillColor=none;fontColor=#000000;align=center;html=1;');
        group.setVertex(true);
        group.setConnectable(false);
        group.setAttribute('c4Type', 'person');
        group.c4 = this;
        var body = new mxCell('', new mxGeometry(0, 70, 170, 110), 'rounded=1;whiteSpace=wrap;html=1;labelBackgroundColor=none;fillColor=#97BCCC;align=center;arcSize=33;strokeColor=#0F6C94;spacing=10;strokeWidth=2;fontSize=13;');
        body.setParent(group);
        body.setVertex(true);
        body.setValue(mxUtils.createXmlDocument().createElement('object'));
        body.setAttribute('label', '<div style="font-size: 14;">name</div><div style="font-size: 11;">[Person]</div><div><br></div><div>Add description</div>');
        body.setAttribute('placeholders', '1');
        body.setAttribute('c4Name', 'name');
        body.setAttribute('c4Type', 'body');
        body.setAttribute('c4Description', 'Add description');
        body.c4 = this;
        var head = new mxCell('', new mxGeometry(40, 0, 80, 80), 'ellipse;whiteSpace=wrap;html=1;aspect=fixed;rounded=0;labelBackgroundColor=none;fillColor=#97BCCC;fontSize=12;align=center;strokeColor=#0F6C94;strokeWidth=2;spacing=5;');
    ...
    C4SoftwareSystem.prototype.create = function () {
        var c4SoftwareSystem = new mxCell('', new mxGeometry(0, 70, 200, 120), 'rounded=1;whiteSpace=wrap;html=1;labelBackgroundColor=none;fillColor=#b1ddf0;align=center;strokeColor=#10739e;perimeterSpacing=0;strokeWidth=2;spacing=10;fontFamily=Helvetica;fontSize=13;');
        c4SoftwareSystem.setVertex(true);
        c4SoftwareSystem.setValue(mxUtils.createXmlDocument().createElement('object'));
        c4SoftwareSystem.setAttribute('label', '<div style="font-size: 14;">name</div><div style="font-size: 11;">[Software System]</div><div><br></div><div>Add description</div>');
        ...
        c4SoftwareSystem.setAttribute('c4Description', 'Add description');
    ...
    C4Container.prototype.create = function () {
        ...
        c4Container.setAttribute('label', '<span>name</span><div>[Container:&nbsp;<span>technology</span><span>]</span></div><div><br></div><div>Add description</div>');
        ...
        c4Container.setAttribute('c4Description', 'Add description');
        c4Container.c4 = this;
        return c4Container;
    };
    ...
    C4Component.prototype.create = function () {
        ...
        c4Component.setAttribute('label', '<span>name</span><div>[Component:&nbsp;<span>technology</span><span>]</span></div><div><br></div><div>Add description</div>');
        ...
        c4Component.setAttribute('c4Description', 'Add description');
        c4Component.c4 = this;
        return c4Component;
    };
    ...
    C4Database.prototype.create = function () {
        ...
        c4Database.setAttribute('label', '<span>Database</span><div>[Container:&nbsp;technology]</div><div><br></div><div>Add description</div>');
        ...
        c4Database.setAttribute('c4Description', 'Add description');
        c4Database.c4 = this;
        return c4Database;
    };
    ...
    C4Relationship.prototype.create = function () {
        var label = '<div style="text-align: left"><div style="text-align: center"><b>escription</b></div><div style="text-align: center">[technology]</div></div>';
        var cell = new mxCell('', new mxGeometry(0, 0, 160, 0), 'edgeStyle=none;rounded=0;html=1;entryX=0;entryY=0.5;jettySize=auto;orthogonalLoop=1;strokeColor=#A8A8A8;strokeWidth=2;fontColor=#525252;fontSize=12;jumpStyle=none;dashed=1;');
        ...
        cell.value.setAttribute('c4Description', 'Add description');
